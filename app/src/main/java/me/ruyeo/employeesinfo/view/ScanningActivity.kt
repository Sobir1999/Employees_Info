...
//        ConnectivityReceiver.registerToActivityAndAutoUnregister(this,
//            object : ConnectivityReceiver(){
//                override fun onConnectionChanged(hasConnection: Boolean) {
//                    if (!hasConnection){
//                        Log.d("Success","Success:!hasConnection")
//                    }else{
//                        Log.d("Success","Success:hasConnection")
//                    }
//                }
...
//        )
        when(come) {
            ...
            2 -> {
                findViewById<TextView>(R.id.idScanningTv).text = getString(R.string.chiqish)
            }
            3 ->{
                findViewById<TextView>(R.id.idScanningTv).text = getString(R.string.tushlikka_chiqish)
            }
            4 ->{
                findViewById<TextView>(R.id.idScanningTv).text = getString(R.string.tushlikdan_qaytish)
            }
        }
...
//                        Utils.toast(this@ScanningActivity, "Yuborilmoqda")
    ...
    private fun showDialogs(
       ...
       dialog.apply {
            ...
            val staffImage = v.findViewById<ImageView>(R.id.person_image)
            val qrcode = v.findViewById<ImageView>(R.id.qrcode)
            val staffName = v.findViewById<TextView>(R.id.txt_content)
            val staff = v.findViewById<TextView>(R.id.txt_content2)
            val title = v.findViewById<TextView>(R.id.come)
            val cameOrWentTime = v.findViewById<TextView>(R.id.txt_name4)
            val cameTime = v.findViewById<TextView>(R.id.txt_content4)
            val fillial = v.findViewById<TextView>(R.id.txt_content5)
            ...
            Glide.with(v).asBitmap().load(portraitBmp).into(staffImage)
            //Glide.with(v).load(image).into(staffImage)
            if (come == 2) {
                title.text = "Ketish"
                cameOrWentTime.text = "Ketgan vaqti:"
            }
            staffName.text = firstName
            cameTime.text = date
            staff.text = position
